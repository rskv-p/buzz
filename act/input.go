...
// SetInputs sets the Inputs field for the Action and validates the number of inputs.
func (a *Action) SetInputs(inputs []any) error {
	if len(inputs) == 0 {
...
// GetInputs returns the current Inputs for the Action.
func (a *Action) GetInputs() []any {
	return a.Inputs
}
